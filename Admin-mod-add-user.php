                            ...
                            <div class="col-lg-12">
                                <div class="card-box">
                                    <h4 class="header-title m-t-0 m-b-5" style="text-align: center; font-size: 22px; padding: 10px;"> Add user</h4>
                                                                            <br>
                                        <form action="Admin-mod-add-user.php#formadd" method="post" id="submitted2">
                                        <div class="form-group">
                                            ...
                                            <select id="settype" name="settype" required="" class="form-control" >
                                                ...
                                                <option <?php if (isset($_REQUEST['settype']) && $_REQUEST['settype']== "Parent" ) echo "selected";  ?> value="Parent">Parent</option>

                                                <option <?php if (isset($_REQUEST['settype']) && $_REQUEST['settype']== "Teacher" ) echo "selected";  ?> value="Teacher">Teacher</option>

                                                <option <?php if (isset($_REQUEST['settype']) && $_REQUEST['settype']== "Account" ) echo "selected";  ?>  value="Account">Account</option>
                                                
                                                <option <?php if (isset($_REQUEST['settype']) && $_REQUEST['settype']== "Admin" ) echo "selected";  ?>  value="Admin">Admin</option>
...
<?php if(isset($_REQUEST['settype'])){
    ...
    echo '
                                    <form action="Admin-mod-add-user.php#formadd" method="post" id="submitted">';
...
<?php if(isset($_REQUEST['settype'])){
    ...
    echo '
                                    <form action="Admin-mod-add-user.php#formadd" method="post" id="submitted">';
                                    if (isset($_REQUEST['settype']) ) echo '<input type="hidden" value="'.$_REQUEST['settype'].'" name="settype">';
                                        dropDownConditional2("Parent ID","gr_number2","addmission_id","guardian_name","ad_admission",NULL);
