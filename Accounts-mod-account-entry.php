                                ...
                                <div class="card-box table-responsive">
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table id="datatable" class="tablesaw table m-b-0 tablesaw-columntoggle table-bordered ">
                                            ...
                                            $sql = 'INSERT INTO `ac_account_entry`(`account_id`, `user_id`, `user_date`, `date_of_entry`, `debit_account_title`, `credit_account_title`, `debit_amount`, `credit_amount`, `comments`) VALUES (NULL,\'';
                                            $sql .= get_curr_user();
                                            $sql .= '\', CURRENT_TIMESTAMP, \''.$_REQUEST['date_of_entry'].'\', \''.$_REQUEST['debit_account_title'].'\', \''.$_REQUEST['credit_account_title'].'\', \''.$_REQUEST['debit_amount'].'\', \''.$_REQUEST['credit_amount'].'\', \''.$_REQUEST['comments'].'\')';
                                            insert_query($sql);
                                                }
                                            // -------------------

                                            ///edit code
                                            check_edit("ac_account_entry","account_id");
                                            edit_display("ac_account_entry","account_id");
                                            //end of edit code -shift view below delete

                                            // -------------------

                                            if(isset($_REQUEST['deleteid']) && is_numeric($_REQUEST['deleteid'])){ $sql = 'DELETE FROM `ac_account_entry` WHERE `ac_account_entry`.`account_id` = '.$_REQUEST['deleteid'];
                                            ...
                                            $sql = 'SELECT `account_id`"ID", `user_id`"User ID", `date_of_entry`"Date of Entry", `debit_account_title`"Debit Account Title", `credit_account_title`"Credit Account Title", `debit_amount`"Debit Amount", `credit_amount`"Credit Amount", `comments`"Comments" FROM `ac_account_entry`';
                                            display_query($sql);
...
<!--                                     <form action="Accounts-mod-account-entry.php#formadd" method="post" id="submitted">
                                      <?php  
                                        ...
                                        <div class="form-group text-right m-b-0">        
                                            <button type="submit" name="submitted" class="btn btn-default waves-effect waves-light m-l-5">
                                                Submit
                                            </button>
                                        </div>
                                   </form> -->
...
?> -->
                                        ...
                                        <form action="Accounts-mod-account-entry.php" method="post">
                                            ...
                                            <div class="form-group">
                                                <label for="prID">Date of Entry </label>
                                                <input type="date" name="date_of_entry" required="" placeholder="Enter date of asset liability" class="form-control" id="prID" value="<?php if (isset($_REQUEST['date_of_entry'])) echo $_REQUEST['date_of_entry']; else echo (date("Y-m-d")); ?>">
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="debit_amount" placeholder="Enter debit amount" class="form-control" id="prName" value="<?php if(isset($_REQUEST['debit_amount'])) echo $_REQUEST['debit_amount'] ?>" >
                                            </div>

                                            <div class="form-group">
                                                <label for="prName">Credit Amount</label>
                                                <input type="number" name="credit_amount" placeholder="Enter credit amount" class="form-control" id="prName" value="<?php if(isset($_REQUEST['credit_amount'])) echo $_REQUEST['credit_amount'] ?>" >
                                            </div>
                                            <div class="form-group">
