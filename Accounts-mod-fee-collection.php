                        ...
                        <div class="row">
                            ...
                            <!-- input form -->
                                <div class="col-lg-12">
                                    ...
                                    <h4 class="header-title m-t-0 m-b-5" style="text-align: center; font-size: 22px; padding: 10px"> Fees Collection</h4>
...
$generate_fee_for_month = "September";//$_REQUEST['which_month'];
$generate_fee_for_year = "2020";// $_REQUEST['year'];
$class_id = 19;//$_REQUEST['class_id'] ;
...
$sql = 'INSERT INTO `ac_fee_collection`(`fee_collection_id`, `user_id`, `user_date`, `which_month`, `year`, `class_id`, `class_name`, `section`, `studend_id`, `student_name`, `month_fee`, `month_con`, `admission_fee`, `admission_con`, `exam_fee`, `exam_con`, `misc_fee`, `misc_con`, `other_fee`, `other_con`, `annual_fee`, `annual_con`, `monfee`, `admfee`, `examfee`, `miscfee`, `specialfee`, `annualfee`, `feesibdisc`, `feeza`, `fee`) VALUES (NULL,\'';

$sql .= get_curr_user();

$sql .= '\', CURRENT_TIMESTAMP, \''.$generate_fee_for_month.'\', \''.$generate_fee_for_year.'\', \''.$class_id.'\', \''.$class_name.'\', \''.$section.'\', \''.$students[$students_count]['gr_no'].'\', \''.$students[$students_count]['name'].'\', \''.$class_fee[0]['monthly_fee'].'\', \''$student_fee[0]['monthly_con'].'\', \''.$class_fee[0]['admission_fee'].'\', \''.$student_fee[0]['admission_con'].'\', \''.$class_fee[0]['exam'].'\', \''.$student_fee[0]['exam_con'].'\', \''.$class_fee[0]['misc'].'\', \''.$student_fee[0]['misc_con'].'\', \''.$class_fee[0]['special'].'\', \''.$student_fee[0]['special_con'].'\', \''.$class_fee[0]['annual'].'\', \''.$student_fee[0]['annual_con'].'\', \''.$monfee.'\', \''.$admfee.'\', \''.$miscfee.'\', \''.$specialfee.'\', \''.$annualfee.'\', \''.$feesibdisc.'\', \''.$feeza.'\', \''.$fee.'\')';
                                                // echo $sql;
...
///edit code
check_edit("ac_fee_collection","fee_collection_id");
edit_display("ac_fee_collection","fee_collection_id");
//end of edit code -shift view below delete

// ---------------------

if(isset($_REQUEST['deleteid']) && is_numeric($_REQUEST['deleteid'])){ $sql = 'DELETE FROM `ac_fee_collection` WHERE `ac_fee_collection`.`fee_collection_id` = '.$_REQUEST['deleteid'];
...
$sql = 'SELECT `fee_collection_id`, `user_id`, `user_date`, `which_month`, `year`, `class_id`, `class_name`, `section`, `studend_id`, `student_name`, `month_fee`, `month_con`, `admission_fee`, `admission_con`, `exam_fee`, `exam_con`, `misc_fee`, `misc_con`, `other_fee`, `other_con`, `annual_fee`, `annual_con`, `date` FROM `ac_fee_collection`';
display_query($sql);
                ...
                <div class="content">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card-box">
                                    <h4 class="header-title m-t-0 m-b-5" style="text-align: center; font-size: 22px; padding: 10px"> Fee Collection </h4>
                                    <br>
                                    <form action="Accounts-mod-fee-collection.php#formadd" method="post" id="submitted">
