                        ...
                        <div class="row">
                            ...
                            <!-- form -->
                                <div class="col-lg-12">
                                    ...
                                    <h4 class="header-title m-t-0 m-b-5" style="text-align: center; font-size: 22px; padding: 10px;"> Assign Class </h4>
                                    <br>
                                    ...
                                    <div class="table-responsive">
                                        <table id="datatable" class="tablesaw table m-b-0 tablesaw-columntoggle table-bordered ">
                                            ...
                                            //print_r($_REQUEST);
                                            $sql = 'INSERT INTO `ad_assign_student_class`(`assign_student_class_id`, `user_id`, `user_date`, `gr_no`, `name`, `date`, `assign_class`, `comment`) VALUES (NULL,\'';
                                            $sql .= get_curr_user();
                                            $sql .= '\', CURRENT_TIMESTAMP, \''.$_REQUEST['gr_no'].'\', \''.$_REQUEST['name'].'\', \''.$_REQUEST['date'].'\', \''.$_REQUEST['assign_class'].'\', \''.$_REQUEST['comment'].'\')';
                                            // echo $sql;
                                            insert_query($sql);
                                            }
                                            // --------------------------
                                            ///edit code
                                            check_edit("ad_assign_student_class","assign_student_class_id");
                                            edit_display("ad_assign_student_class","assign_student_class_id");
                                            //end of edit code -shift view below delete
                                            // --------------------------

                                            if(isset($_REQUEST['deleteid']) && is_numeric($_REQUEST['deleteid'])){ $sql = 'DELETE FROM `ad_assign_student_class` WHERE `ad_assign_student_class`.`assign_student_class_id` = '.$_REQUEST['deleteid'];
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card-box">
                                    <h4 class="header-title m-t-0 m-b-5" style="text-align: center; font-size: 22px; padding: 10px;">Assign Class</h4>
                                    <br>
                                    <form action="Admin-mod-assign-student-class.php#formadd" method="post" id="submitted">
                                        <?php
...
?>
                                    <form action="Admin-mod-assign-student-class.php" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="date" placeholder="Enter date" required class="form-control" value="<?php if (isset($_REQUEST['date'])) echo $_REQUEST['date']; else echo (date("Y-m-d")); ?>">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label for="lcDateOfBirthW">Comments</label>
                                            <textarea type="textarea" name="comment" row = "2"placeholder="Enter comment" 
                                            class="form-control" id="lcDateOfBirthW"
                                            ><?php if(isset($_REQUEST['comment'])) echo $_REQUEST['comment']?></textarea>
                                        </div>
                                        <div class="form-group text-right m-b-0">
                                            <?php 
                                            code_submit();
