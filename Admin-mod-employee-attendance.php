                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="table-responsive">
                                        <table id="datatable" class="tablesaw table m-b-0 tablesaw-columntoggle table-bordered ">
                                            ...
                                            //print_r($_REQUEST);
                                            $sql = 'INSERT INTO `ad_employee_attendance`(`employee_attendance_id`, `user_id`, `user_date`, `name`, `id_num`, `status`, `date`) VALUES (NULL, \'';
                                            $sql .= get_curr_user();
                                            ...
                                            check_edit("ad_employee_attendance","employee_attendance_id");
                                            edit_display("ad_employee_attendance","employee_attendance_id");
                                            ...
                                            if(isset($_REQUEST['deleteid']) && is_numeric($_REQUEST['deleteid'])){ $sql = 'DELETE FROM `ad_employee_attendance` WHERE `ad_employee_attendance`.`employee_attendance_id` = '.$_REQUEST['deleteid'];
                ...
                <div class="content">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card-box">
                                        <h4 class="header-title m-t-0 m-b-5" style="text-align: center; font-size: 22px; padding: 10px"> Staff Attendance </h4>
                                        <br>
                                        <form action="Admin-mod-employee-attendance.php#formadd" method="post" id="submitted">
                                        <?php
                                        dropDownConditional2("Member ID","id_num2","employee_record_id","name","ad_employee_record",NULL);
                                        ?>
...
if(isset($_REQUEST['id_num2'])){
    $conn = connect_db();
    $sql_s = 'SELECT `employee_record_id`,`name` FROM `ad_employee_record` WHERE `employee_record_id` = '.$_REQUEST['id_num2'].' ';
...
?>
                                        <form action="Admin-mod-employee-attendance.php" method="post" >
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name" required="" placeholder="Enter teacher's name" class="form-control" id="zaStudentsName" <?php if(isset($_REQUEST['id_num2']))echo 'value="'.$value_name.'" readonly' ;else { if(isset($_REQUEST['name'])) echo'value="'.$_REQUEST['name'].'" readonly';} ?>>
                                            </div>
                                            <div class="form-group">
                                                <label for="id_num">ID</label>
                                                <input type="text" name="id_num" required="" placeholder="Enter ID#" class="form-control" <?php if(isset($_REQUEST['id_num2']))echo 'value="'.$value_id.'" readonly' ;else { if(isset($_REQUEST['id_num'])) echo'value="'.$_REQUEST['id_num'].'" readonly';} ?>>
                                            </div>
                                            <div class="form-group">
