                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card-box">
                                    ...
                                    <form action="Accounts-mod-annual-appraisal-for-bonus-and-increment.php#fromadd" method="post" id="submitted2">
...
<?php if(isset($_REQUEST['settype'])){
    ...
    echo '
                                    <form action="Accounts-mod-annual-appraisal-for-bonus-and-increment.php#fromadd" method="post" id="submitted">';
