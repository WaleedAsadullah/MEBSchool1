                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="card-box table-responsive">
                                    <h4 class="header-title m-t-0 m-b-5" style="text-align: center; font-size: 22px; padding: 10px"> Subjects </h4>
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table id="datatable" class="tablesaw table m-b-0 tablesaw-columntoggle table-bordered ">
                                            ...
                                            ///edit codes
                                            check_edit("ad_subject","subject_id");
                                            edit_display("ad_subject","subject_id");
                                            //end of edit code -shift view below delete

                                            // -------------------

                                            if(isset($_REQUEST['deleteid']) && is_numeric($_REQUEST['deleteid'])){ $sql = 'DELETE FROM `ad_subject` WHERE `ad_subject`.`subject_id` = '.$_REQUEST['deleteid'];
